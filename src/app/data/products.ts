...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 32.50,
    image: '/images/baiao_de_dois.png',
    category: 'baiao',
    rating: 4.9,
    reviewCount: 389,
    prepTime: '20 min',
